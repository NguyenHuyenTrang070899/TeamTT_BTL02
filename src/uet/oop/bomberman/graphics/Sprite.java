...
public class Sprite {
	...
	public static Sprite player_left_1 = new Sprite(16, 3, 1, SpriteSheet.tiles, 12, 16);
	public static Sprite player_left_2 = new Sprite(16, 3, 2, SpriteSheet.tiles, 12 ,16);
	
	public static Sprite player_right_1 = new Sprite(16, 1, 1, SpriteSheet.tiles, 12, 16);
	...
	//Doria
	public static Sprite doria_left1 = new Sprite(16, 6, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite doria_left2 = new Sprite(16, 6, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite doria_left3 = new Sprite(16, 6, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite doria_right1 = new Sprite(16, 7, 5, SpriteSheet.tiles, 16, 16);
	public static Sprite doria_right2 = new Sprite(16, 7, 6, SpriteSheet.tiles, 16, 16);
	public static Sprite doria_right3 = new Sprite(16, 7, 7, SpriteSheet.tiles, 16, 16);

	public static Sprite doria_dead = new Sprite(16, 6, 8, SpriteSheet.tiles, 16, 16);
